...
export default class Physics
{
    ...
    setCar()
    {
        ...
        this.car.options.controlsSteeringSpeed = 0.0055 * 3
        this.car.options.controlsSteeringMax = Math.PI * 0.185
        this.car.options.controlsSteeringQuad = false
        this.car.options.controlsAcceleratinMaxSpeed = 0.05 * 3 / 17
        this.car.options.controlsAcceleratinMaxSpeedBoost = 0.095 * 3 / 17
        this.car.options.controlsAcceleratingSpeed = 1.85 * 4 * 2
        this.car.options.controlsAcceleratingSpeedBoost = 3.1 * 4 * 2
